...
{
public:
    Sequence(int size);     // Create a sequence with input size

    Sequence();    // Create an empty sequence with the size of DEFAULT_MAX_ITEMS
...
private:
    int m_size;
    int m_maxSize = DEFAULT_MAX_ITEMS;
    ItemType *m_items;
};
